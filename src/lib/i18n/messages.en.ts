...
export const MESSAGES_EN = {
  ...
  'landing.trust.privacy.desc': "Your documents stay on your device until you submit for review. We never share with USCIS or anyone else.",
  ...
  'landing.faq.q1.a': "Yes. Your documents stay on your device. We don't work with USCIS — we're independent. But if you're worried, use a trusted friend's device and delete browser history after.",
  ...
  'landing.faq.q4.q': "Do you share data with USCIS?",
