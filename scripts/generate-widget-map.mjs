...
const SCHEMAS = {
  ...
  'i-589': {
    description:
      'I-589 Application for Asylum and Withholding of Removal — filed by someone seeking asylum in the U.S. Must be filed within 1 year of entry.',
    paths: [
      'applicant.name.familyName',
      'applicant.name.givenName',
      'applicant.aNumber',
      ...
      'applicant.daytimePhone',
      'applicant.emailAddress',
      'spouse.name.familyName',
      'spouse.name.givenName',
      'spouse.dateOfBirth',
      'spouse.aNumber',
      'signature.date',
    ],
  ...
  'i-765': {
    description:
      'I-765 Application for Employment Authorization — filed to get a work permit (EAD). Often filed alongside asylum, AOS, or other pending status.',
    paths: [
      'applicant.name.familyName',
      'applicant.name.givenName',
      'applicant.name.middleName',
  ...
  'i-821': {
    description:
      'I-821 Application for Temporary Protected Status — filed by nationals of TPS-designated countries to remain lawfully in the U.S. during emergencies.',
    paths: [
      'applicant.name.familyName',
      'applicant.name.givenName',
      'applicant.name.middleName',
